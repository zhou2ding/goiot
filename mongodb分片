...
### 分片集群架构
* 架构示意图
![cluster_architecture][img_2_cluster_interaction]
如上图所示，分片集群由三种组件构成
...
![chunk_split_migrate][img_7_chunk_split_migrate]
...
#### 集群搭建步骤
1. 目录结构
![cluster_dirs][img_9_cluster_dirs]
```
...
### 关于分片的索引问题
* 如下图所示
![shard_index][img_10_shard_index]
