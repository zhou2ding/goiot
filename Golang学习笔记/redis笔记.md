...
![image-20210430111738570](redis笔记.assets\image-20210430111738570.png)
...
![image-20210430160658134](redis笔记.assets\image-20210430160658134.png)
...
- `redis-benchmark`性能测试：`redis-benchmark -h localhost -p 6379 -c 100 -n 100000`，测试结果如下
  ...
  ![image-20210430172506575](redis笔记.assets\image-20210430172506575.png)
...
![image-20210503221505925](redis笔记.assets\image-20210503221505925.png)
...
![image-20210504105343034](redis笔记.assets\image-20210504105343034.png)

![image-20210504104856796](redis笔记.assets\image-20210504104856796.png)
