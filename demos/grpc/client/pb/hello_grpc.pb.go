...
const (
	...
	Greeter_LotsOfRequests_FullMethodName = "/pb.Greeter/LotsOfRequests"
...
func (c *greeterClient) LotsOfRequests(ctx context.Context, opts ...grpc.CallOption) (Greeter_LotsOfRequestsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], Greeter_LotsOfRequests_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
